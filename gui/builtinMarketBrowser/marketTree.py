...
class MarketTree(wx.TreeCtrl):
    ...
    def __init__(self, parent, marketBrowser):
        ...
        for mktGrp in sMkt.getMarketRoot():
            ...
            childId = self.AppendItem(self.root, mktGrp.nameCn, iconId, data=mktGrp.ID)
        ...
        self.AppendItem(self.root, "最近使用的装备", rumIconId, data=RECENTLY_USED_MODULES)
    ...
    def expandLookup(self, event):
        ...
        if self.GetItemText(child) == "dummy":
            ...
            for childMktGrp in sMkt.getMarketGroupChildren(currentMktGrp):
                ...
                try:
                    childId = self.AppendItem(root, childMktGrp.nameCn, iconId, data=childMktGrp.ID)
