...
class ItemStatsFrame(AuxiliaryFrame):
    ...
    def __init__(
        ...
        self.SetTitle("%s: %s%s" % ("%s 属性" % itmContext if itmContext is not None else "属性", item.name,
