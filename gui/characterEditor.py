...
class CharacterEditor(AuxiliaryFrame):
    ...
    def __init__(self, parent):
        super().__init__(
            parent, id=wx.ID_ANY, title="人物编辑", resizeable=True, pos=wx.DefaultPosition,
        ...
        self.viewsNBContainer.AddPage(self.sview, "技能")
        self.viewsNBContainer.AddPage(self.iview, "脑插")
        ...
        self.btnSaveChar = wx.Button(self, wx.ID_ANY, "保存")
        self.btnSaveAs = wx.Button(self, wx.ID_ANY, "保存为...")
        self.btnRevert = wx.Button(self, wx.ID_ANY, "重置")
...
class APIView(wx.Panel):
    def __init__(self, parent):
        ...
        self.addButton = wx.Button(self, wx.ID_ANY, "通过EVE SSO登录", wx.DefaultPosition, wx.DefaultSize, 0)
