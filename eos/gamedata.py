...
class Item(EqBase):
    ...
    def __repr__(self):
        return "Item(ID={}, name={},nameCn={}) at {}".format(
            self.ID, self.name, self.nameCn, hex(id(self))
        )
...
class MarketGroup(EqBase):
    def __repr__(self):
        return "MarketGroup(ID={}, name={},nameCn={}, parent={}) at {}".format(
            self.ID, self.name, self.nameCn, getattr(self.parent, "name", None), hex(id(self)))
