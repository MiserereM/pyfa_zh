...
items_table = Table("invtypes", gamedata_meta,
                    ...
                    Column("typeNameCn", String),
                    Column("description", String),
                    Column("descriptionCn", String),
...
mapper(Item, items_table,
       properties={
           ...
           "name"             : synonym("typeName"),
            "nameCn"             : synonym("typeNameCn"),
           "description"      : deferred(items_table.c.descriptionCn),
            "descriptionCn"      : deferred(items_table.c.description),
